...
from jaxpruner.projects.bigsparse.t5x import decoder_layers as layers
...
class TransformerW(nn.Module):
  """Decoder with width scaling."""
  ...
  def setup(self):
    ...
    self.decoder = Decoder(new_cfg, name='decoder')
